...
export default function AddEditTaskModal({
  ...
  return (
    ...
    >
      <div className="modal">
        <h3>{type === "edit" ? "Edit" : "Añadir nueva"} Tarea</h3>
        ...
        <div className="input-container">
          ...
          />
          {!isValid && !title.trim() && (
            <span className="cant-be-empty-span text-L"> No se puede dejar vacio</span>
          )}
        </div>

        <label htmlFor="task-name-input">Descripción</label>
        ...
        <div className="select-column-container">
          <label className="text-M">Estado actual</label>
          <select
